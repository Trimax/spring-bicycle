...
public final class GreaterExpression extends AbstractLogicalExpression {
    private final AbstractStringExpression parameter;
    private final AbstractColumn column;

    public GreaterExpression(final AbstractColumn column, final AbstractStringExpression parameter) {
